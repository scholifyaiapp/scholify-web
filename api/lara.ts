...
- Partner programme: every approved partner earns 27% of qualifying payments. Monthly referrals earn on the first payment, expanding prospectively to the first 3 payments at 300 unique paid learners and the first 5 at 600; annual plans earn once on the full annual payment. The window is a maximum, not a guarantee — commissions accrue only on invoices actually collected, so if a learner cancels mid-window their window simply ends with their last paid month. First-touch attribution lasts 90 days, every commission has a 30-day validation hold, and refunds or chargebacks do not qualify.
