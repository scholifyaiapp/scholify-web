...
- Partner programme: activation is instant — applying at /partners/apply issues a live link and code immediately, delivered by welcome email. Every partner earns 27% of qualifying payments. Monthly referrals earn on the first payment, expanding prospectively to the first 3 payments at 300 unique paid learners and the first 5 at 600; annual plans earn once on the full annual payment. The window is a maximum, not a guarantee — commissions accrue only on invoices actually collected, so if a learner cancels mid-window their window simply ends with their last paid month. First-touch attribution lasts 90 days, every commission has a 30-day validation hold, and refunds or chargebacks do not qualify. Payouts run monthly: cleared balances of $50+ are paid in the first week of each month (bank transfer, Wise or PayPal), smaller balances roll over; partners receive an email per commission and a weekly Monday digest. Full terms: scholifyapp.com/partner-agreement.html (v1.1).
