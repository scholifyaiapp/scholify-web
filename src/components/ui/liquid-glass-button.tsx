...
/* Render once at the page root so every LiquidButton can reference #container-glass without ID dupes */
export function LiquidGlassFilterDefs() {
  return (
    <svg className="absolute h-0 w-0 overflow-hidden" aria-hidden style={{ position: "absolute", inset: 0, pointerEvents: "none" }}>
      <defs>
