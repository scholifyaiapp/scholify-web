 ...
 * ─────────────────────────────────────────────────────────────────
 *
 * Each KEY is the exact English string shown in the UI; the VALUE is
 * its Russian translation. An empty value ("") falls back to English.
 *
 * Do NOT change the keys — they must match the code exactly, including
 * punctuation like — · × → … and apostrophes.
 *
 * Note: these translations are a solid first pass — a native Russian
 * speaker should review tone/marketing nuance before a wide launch.
 * ─────────────────────────────────────────────────────────────────
 */
...
export const ru: Record<string, string> = {
  ...
  /* ── Problem ── */
  "The internet gave you everything to learn.": "Интернет дал вам всё для учёбы.",
  "Scholify gives you the discipline to finish.":
    "Scholify даёт дисциплину, чтобы дойти до конца.",
  "of online courses are abandoned within 30 days — not from lack of motivation, but lack of a daily rhythm. Scholify is the rhythm.":
    "онлайн-курсов забрасывают в первые 30 дней — не из-за нехватки мотивации, а из-за отсутствия ежедневного ритма. Scholify — это ритм.",
  "of online courses never finished": "онлайн-курсов так и не заканчивают",
  "Source: MIT research": "Источник: исследование MIT",
  "is all Scholify asks per day": "— всё, что Scholify просит в день",
  "Less than one TikTok scroll": "Меньше одного скролла в TikTok",
  "more consistent than self-study": "стабильнее самостоятельного обучения",
  "Based on habit formation research": "По данным исследований формирования привычек",
  ...
  "Generates unique plans for any learning goal":
    "Создаёт уникальные планы для любой учебной цели",
  "Progressive difficulty — starts easy, builds up":
    "Постепенная сложность — от простого к сложному",
  ...
  "Your AI Partner is built into Scholify. It knows your name, your streak, your goal, and today's task. Every message it sends is generated just for you — specific, real, and actually useful.":
    "Ваш ИИ-партнёр встроен в Scholify. Он знает ваше имя, вашу серию, вашу цель и сегодняшнее задание. Каждое сообщение создаётся именно для вас — конкретное, настоящее и действительно полезное.",
  "Personalised messages using your real data":
    "Персональные сообщения на основе ваших реальных данных",
  "Voice mode — hear your AI Partner speak (Pro)":
    "Голосовой режим — услышьте своего ИИ-партнёра (Pro)",
  "Speaking practice with AI scoring (Pro)":
    "Разговорная практика с оценкой ИИ (Pro)",
  "Available in 29 languages": "Доступно на 29 языках",
  "PROGRESS": "ПРОГРЕСС",
  "Progress you'll want to show off.": "Прогресс, которым захочется похвастаться.",
  "Shareable weekly report cards. 30-day heatmaps. Goal completion certificates. A Year Rewind video on Annual Pro. Every milestone is designed to be shared.":
    "Еженедельные карточки-отчёты, которыми можно делиться. Тепловые карты за 30 дней. Сертификаты о достижении цели. Видео «Итоги года» в годовом Pro. Каждая веха создана, чтобы ею делиться.",
  "Weekly progress card for Instagram Stories":
    "Еженедельная карточка прогресса для историй Instagram",
  "30-day completion heatmap": "Тепловая карта выполнения за 30 дней",
  "Goal completion certificate (PDF)": "Сертификат о достижении цели (PDF)",
  "Streak tree that grows with you": "Дерево серии, которое растёт вместе с вами",
  "Year Rewind video at 12 months (Annual)":
    "Видео «Итоги года» через 12 месяцев (годовой план)",
  ...
  "Share": "Поделиться",
  "STORY · 1080×1920": "ИСТОРИЯ · 1080×1920",
  "Day": "День",
  "Still here.": "Всё ещё здесь.",

  /* ── Feature swiper ── */
  "BUILT FOR EVERY GOAL": "ДЛЯ ЛЮБОЙ ЦЕЛИ",
  "Six ways Scholify": "Шесть способов, которыми Scholify",
  "shows up for you.": "помогает вам.",
  "Swipe through the deck — every card is a real piece of how the app works.":
    "Пролистайте колоду — каждая карточка показывает, как на самом деле работает приложение.",
  "DRAG TO SWIPE · LEFT OR RIGHT": "ПЕРЕТАСКИВАЙТЕ · ВЛЕВО ИЛИ ВПРАВО",

  /* ── Identity ── */
  "THE TRANSFORMATION": "ТРАНСФОРМАЦИЯ",
  "You're not learning a skill.": "Вы не просто осваиваете навык.",
  "You're becoming someone who shows up.": "Вы становитесь тем, кто не сдаётся.",
  "Drag the slider — see what 60 days of Scholify actually changes.":
    "Двигайте ползунок — посмотрите, что на самом деле меняют 60 дней со Scholify.",
  ...
  "A student before using Scholify — distracted, surrounded by unfinished courses and unused notebooks.":
    "Студент до Scholify — рассеянный, среди незаконченных курсов и неиспользованных тетрадей.",
  ...
  "Remember for 30 days": "Запомнить на 30 дней",
  ...
  "Please enter a valid email and a password of at least 4 characters.":
    "Введите корректный email и пароль не короче 4 символов.",

  /* ── Sign up ── */
  "Signing you up...": "Регистрируем вас…",
  "Building your plan...": "Составляем ваш план…",
  "Finalizing...": "Завершаем…",
  "Welcome to Scholify!": "Добро пожаловать в Scholify!",
  "Passwords do not match!": "Пароли не совпадают!",
  "Close": "Закрыть",
  "Try Again": "Попробовать снова",
  "Start your streak": "Начните свою серию",
  ...
  "Confirm your password to continue.": "Подтвердите пароль, чтобы продолжить.",
  "Continue with email": "Продолжить с email",
  "Toggle password visibility": "Показать или скрыть пароль",
  "Submit password": "Подтвердить пароль",
  "Go back": "Назад",
  ...
  "the roadmap recalculates": "маршрут пересчитывается",
