...
/*
 * The original topic briefs — FA and FR. Split out of acca-briefs.ts so the
 * barrel stays eager while the BRIEFS load per paper. Loaded only through
 * acca-paper-content.ts.
 */
export const CORE_BRIEFS: TopicBrief[] = [
