...
/*
 * The original seed flashcards. Split out of acca-flashcards.ts so the barrel
 * (types + the Leitner scheduler) stays eager while the CARDS load per paper.
 * Loaded only through acca-paper-content.ts.
 */
