...
/*
 * The original seed written (constructed-response) questions — FR, SBL, SBR.
 * Split out of acca-written.ts so the barrel stays eager while the QUESTIONS
 * load per paper. Loaded only through acca-paper-content.ts.
 */
export const CORE_WRITTEN: WrittenQuestion[] = [
  {
    id: "FR-W-01",
    paper: "FR",
    area: "B",
