...
/*
 * The demo seed feed lived here: a fabricated community of named people
 * ("Dilnoza M.", IELTS goals — ghosts of the pre-ACCA vocab product) posting
 * invented streak milestones. `ensureSeeded()` had no caller, so none of it ever
 * rendered — but invented social proof has no business sitting in the repo of a
 * product about to be announced. Deleted 2026-07-14.
 */
