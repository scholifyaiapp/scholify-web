...
const ru: PageContent = {
  ...
  sections: [
    ...
    {
      heading: "Сначала спросите Чарльза",
      body: [
        "По вопросам о вашем плане занятий, сериях или о том, как работает та или иная функция, Чарльз — ваш ИИ-партнёр прямо в приложении — часто может помочь сразу же, в любое время суток.",
      ],
    },
    {
